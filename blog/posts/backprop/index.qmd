...
- Symbolic differentation can be performed with systems like Maple or Mathematica. This gives us _expressions_ for the derivatives, which might grow exponentially large.
- Automatic differentation gives as _values_ for derivatives (not expressions) in a computational complexity comparable to the forward pass. 
