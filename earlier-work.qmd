---
title: "Earlier work, 2019–2023"
pagetitle: "Earlier work | Kevin Maik Jablonka"
description-meta: "Doctoral and early postdoctoral work on data-driven materials design and machine-actionable experimental data — the origin of the current research programme."
sidebar: false
format:
  html:
    css: research.css
    include-in-header:
      - text: |
          <link rel="canonical" href="https://kjablonka.com/earlier-work.html">
---

::: {.callout appearance="simple"}
**This is an archive page.** It describes doctoral and early postdoctoral work at EPFL, completed in 2023. For the current programme at LAMALab in Jena, see [Research](research.html).
:::

This work established two commitments the current programme still rests on: that models should learn from the data experiments actually produce, and that computational work without open code and open data is advertisement. The questions have since moved from designing materials to measuring scientific concepts and judgement.
...
### An ecosystem for data-driven material design 
...
To address this, we developed an open-source ecosystem for digital reticular chemistry, called [mofdscribe](https://github.com/kjappelbaum/mofdscribe).
...
With the tools and datasets mofdscribe provides, we could use machine learning tools to address challenging material design problems.

We did this from the atom scale up to the pilot plant scale: 
...
- Beyond this, we have also been using machine learning to predict the color (see [paper](https://pubs.rsc.org/en/content/articlelanding/2021/sc/d0sc05337f)) as well as gas adsorption properties (see [paper](https://doi.org/10.1038/s41467-020-17755-8)) of MOFs.
...
### Representations and models of chemistry 

For machine learning to work, it is important to work on actionable representations that are predictive. 
I think foundation models can help us reveal some of the tacit knowledge of chemistry. 
...
To ensure that data is not an afterthought in chemistry, I got involved in the development of an open-source ELN, the [cheminfo ELN](https://cheminfo.github.io) (which development is led by Luc Patiny, our [perspective article](https://www.nature.com/articles/s41557-022-00910-7) gives a good overview of our vision for the development of this platform).
